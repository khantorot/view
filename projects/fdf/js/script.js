...
if (!(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))) {
    function App() {
        ...
        function init() {
            ...
            renderer.domElement.addEventListener('mousemove', e => {
                if (camera.position.z > 30) {
                    ...
                    ripple.addDrop(gp.x, gp.y, 0.1, 0.1);//here
                }
            });
        ...
        function initScene() {
            ...
            let pointLight1 = new THREE.PointLight("white");
            pointLight1.position.set(-wWidth / 2, wHeight / 2, 50);
            scene.add(pointLight1);

            let pointLight2 = new THREE.PointLight("white");
            pointLight2.position.set(wWidth / 2, wHeight / 2, 50);
            scene.add(pointLight2);

            let pointLight3 = new THREE.PointLight("white");
            pointLight3.position.set(-wWidth / 2, -wHeight / 2, 50);
            scene.add(pointLight3);

            let pointLight4 = new THREE.PointLight("white");
            pointLight4.position.set(wWidth / 2, -wHeight / 2, 50);
            scene.add(pointLight4);

            const colors = ["white", "red", "blue", "orange", "green"]; //here
            let color_id = 0;
    ...
    `;
            ...
            camera.position.set(0, -gridWHeight / 8, 8); //here
        ...
        function animate() {
            ...
            if (!mouseOver) {
                ...
                //   ripple.addDrop(x, y, 0.05, -0.04);   added by me
            }
